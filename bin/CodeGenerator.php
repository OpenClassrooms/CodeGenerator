...
$application->add(new \OpenClassrooms\CodeGenerator\Commands\GetEntityUseCaseCommand());
$application->add(new \OpenClassrooms\CodeGenerator\Commands\GetEntitiesUseCaseCommand());
$application->run();
