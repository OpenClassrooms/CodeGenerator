...
use OpenClassrooms\CodeGenerator\SkeletonModels\Api\ViewModelDetailTestCase\Impl\ViewModelDetailTestCaseSkeletonModelAssemblerImpl;
...
class ViewModelDetailTestCaseGeneratorTest extends TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->viewModelDetailTestCaseGenerator->setTemplating(new TemplatingMock());
