    ...
    private function buildVm(PaginatedUseCaseResponse $response): ListFunctionalEntities
    {
        return
            $this->get('oc.app.view_models.web.domain.sub_domain.list_functional_entities_builder')
                ...
                ->withPagination($this->get('oc.view_models.pagination.pagination_factory')->createFromPaginatedUseCaseResponse($response, 'oc_web_domain_sub_domain_admin_list_functional_entities'))
                ->build();
    }
}
