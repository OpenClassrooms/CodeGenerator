...
final class EntityFileObjectType
{
    ...
    const BUSINESS_RULES_ENTITY_FACTORY             = 'BUSINESS_RULES_ENTITY_FACTORY';

    const BUSINESS_RULES_ENTITY_FACTORY_IMPL        = 'BUSINESS_RULES_ENTITY_FACTORY_IMPL';
    ...
    const BUSINESS_RULES_ENTITY_REPOSITORY          = 'BUSINESS_RULES_ENTITY_REPOSITORY';
