...
class CreateEntityTestGenerator extends AbstractUseCaseGenerator
{
    /**
     * @var CreateEntityTestSkeletonModelBuilder
     */
    private $createEntityTestSkeletonModelBuilder;

    /**
     * @param CreateEntityTestGeneratorRequest $generatorRequest
     */
    public function generate(GeneratorRequest $generatorRequest): FileObject
    {
        $createEntityTestFileObject = $this->buildCreateEntityTestFileObject(
    ...
    private function buildCreateEntityTestFileObject(string $entityClassName): FileObject
    {
        $this->initFileObjectParameter($entityClassName);
        $createEntityTestFileObject = $this->createCreateEntityTestFileObject();
        $createEntityFileObject = $this->createEntityFileObject();
        $createEntityRequestFileObject = $this->createEntityRequestFileObject();
    ...
    private function createCreateEntityTestFileObject(): FileObject
    {
    ...
    private function createEntityRequestFileObject()
    {
    ...
    private function createEntityRequestBuilderImplFileObject()
    {
        return $this->useCaseRequestFileObjectFactory->create(
    ...
    private function createEntityRequestDTOFileObject()
    {
        return $this->useCaseRequestFileObjectFactory->create(
    ...
    private function createSkeletonModel(array $fileObjects): CreateEntityTestSkeletonModel
    {
        return $this->createEntityTestSkeletonModelBuilder->create()
            ->withCreateCreateEntityTestFileObject(
                $fileObjects[UseCaseFileObjectType::BUSINESS_RULES_CREATE_ENTITY_USE_CASE_TEST]
            )
            ->withCreateEntityFileObject($fileObjects[UseCaseFileObjectType::BUSINESS_RULES_CREATE_ENTITY_USE_CASE])
            ->withCreateEntityRequestFileObject(
                $fileObjects[UseCaseRequestFileObjectType::BUSINESS_RULES_CREATE_ENTITY_USE_CASE_REQUEST]
            )
            ->withCreateEntityRequestBuilderImplFileObject(
                $fileObjects[UseCaseRequestFileObjectType::BUSINESS_RULES_CREATE_ENTITY_USE_CASE_REQUEST_BUILDER_IMPL]
            )
            ->withCreateEntityRequestDTOFileObject(
    ...
    public function setCreateEntityTestSkeletonModelBuilder(
        CreateEntityTestSkeletonModelBuilder $createEntityTestSkeletonModelBuilder
    ): void {
